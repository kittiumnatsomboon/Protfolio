...
export const FaqSection = () => {
    ...
    return (
        <div className="relative max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            <img className="absolute -mb-120 -left-40 -z-10 pointer-events-none" src={theme === "dark" ? "./assets/color-splash.svg" : "./assets/color-splash-light.svg"} alt="color-splash" width={1000} height={1000} fetchPriority="high" />
